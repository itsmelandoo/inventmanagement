...
<head>
    ...
    <title>Sales | NAVI Merchandise</title>
    <link rel="stylesheet" href="/php/style.css">
    <script type="text/javascript" src="/php/home.js" defer></script>
</head>
<body>
    <nav>
        <h4 class="title">NAVI General Merchandise</h4>
        <a href="/php/index/index.php">Logout</a>
    </nav>
    <aside id="sidebar">
      <ul>
        <li>
            <img src="/php/svg/logo-removebg-preview.png" alt="">
